...
def run_module():
    try:
        import ansible_collections.repo_setup.repos.plugins.module_utils. \
            repo_setup.yum_config.constants as const
        from ansible_collections.repo_setup.repos.plugins.module_utils. \
            repo_setup.yum_config import utils
    except ImportError:
    ...
    try:
        try:
            import ansible_collections.repo_setup.repos.plugins.module_utils.\
                repo_setup.yum_config.yum_config as cfg
        except ImportError:
        ...
        if module.params['type'] == 'repo':
            ...
            try:
                import ansible_collections.repo_setup.repos.plugins.module_utils.\
                    repo_setup.yum_config.compose_repos as repos
            except ImportError:
            ...
            try:
                import ansible_collections.repo_setup.repos.plugins.module_utils.\
                    repo_setup.yum_config.dnf_manager as dnf_mgr
            except ImportError:
